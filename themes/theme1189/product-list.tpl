                        ...
                        <div class="col-xs-12 padding-0">
                            ...
                            {else}
                                <div class="col-xs-12 padding-0">
                                    <div class="col-xs-12 padding-0">
                            {/if}
                                    <div class="btn btn-default selection cursor-pointer {if !$isInSelection}btn-add{else}btn-remove{/if} product-{$product.id_product}" data-product-link="{$product.link|escape:'html':'UTF-8'}" data-img="{$link->getImageLink($product.link_rewrite, $product.id_image, 'tm_home_default')|escape:'html':'UTF-8'}" data-img-large="{$link->getImageLink($product.link_rewrite, $product.id_image, 'tm_thickbox_default')|escape:'html':'UTF-8'}" data-type="{if $product.category == 'products'}product{else}design{/if}" data-id="{$product.id_product}" data-product-title="{$product.name}" title="{if !$isInSelection} {l s='Add to selection'} {else} {l s='Remove from selection'}{/if}" data-text-add="{l s='Add to selection'}" data-text-remove="{l s='Remove from selection'}">
