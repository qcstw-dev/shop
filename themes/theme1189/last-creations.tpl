            ...
            <div class="product-container" >
                <div class="left-block">
                    <div class="product-image-container padding-top-20 padding padding-bottom-20">
                        <img class="img-responsive border  padding-bottom-10 padding-top-10 popup" src="{$custom_picture_path}{$creation.custom_picture}.png" alt="last creation" title="last creation" />
                    </div>
                </div>
