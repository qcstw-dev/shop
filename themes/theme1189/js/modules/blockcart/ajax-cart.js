            ...
            success: function (jsonData, textStatus, jqXHR)
            {
                ...
                if (!jsonData.hasError)
                {
                    ...
                    $(jsonData.products).each(function() {
                        if (this.id == parseInt(idProduct)) {
                            aProducts.push(this.custom_picture.split('_')[0]);
                        }
                    });
                    ...
                    if (idCombination)
                        $(jsonData.products).each(function () {
                            if (this.id != undefined && this.id == parseInt(idProduct) && this.idCombination == parseInt(idCombination) && this.custom_picture.split('_')[0] == MoreRecentCustomPicture)
                                if (contentOnly)
                        ...
                        $(jsonData.products).each(function () {
                            if (this.id != undefined && this.id == parseInt(idProduct) && this.custom_picture.split('_')[0] == MoreRecentCustomPicture)
                                if (contentOnly)
                                    window.parent.ajaxCart.updateLayer(this);
                                else
                                    ajaxCart.updateLayer(this);
