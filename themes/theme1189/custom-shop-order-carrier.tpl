<form id="form" action="{$base_uri}shop/{$custom_shop_name}/checkout?step=5" method="post" name="carrier_area">
    {foreach $delivery_option_list as $id_address => $option_list}
        {foreach $option_list as $key => $option}
            ...
            <div class="col-xs-4 col-lg-1 thumbnail border-none delivery_option_logo">
    ...
    <div class="col-xs-12">
        ...
        <label for="cgv" class="cursor-pointer">
            ...
            <span class="popup-cms-content cursor-pointer" data-page="terms">{l s='(Read the Terms of Service)'}</span>
        </label>
