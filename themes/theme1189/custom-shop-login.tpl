<div class="col-xs-12 block-checkout block-login font-size-13">
    <div class="col-xs-12 col-lg-6">
        <div class="col-xs-12 border padding-bottom-10">
            ...
            <hr>
            <form action="{$base_uri}shop/{$custom_shop_name}/checkout" method="post" id="create-account_form">
                ...
                <div class="col-xs-12 input-group">
                    <div class="form-group">
                        ...
                        <input type="hidden" class="is_required" name="back" value="{$base_uri}shop/{$custom_shop_name}/checkout?step=3" required/>
