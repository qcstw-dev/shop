...
<div class="box">
    <div class="font-size-20 text-center bold">{l s='Your addresses'}</div>
    <hr>
    <p class="info-title">
    ...
    <form action="{$link->getPageLink('mobile-address', true)|escape:'html':'UTF-8'}" method="post" class="std" id="add_address">
        ...
        <p class="submit2">
            ...
            <button type="submit" name="submitAddress" id="submitAddress" class="btn btn-primary col-xs-12 col-sm-4 pull-right">
