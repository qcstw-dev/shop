...
<div data-role="content" id="content" class="cart">
    ...
    {if !$is_guest}
        <a class="underline" href="{$base_uri}mobile" data-role="button" data-theme="a" data-icon="back" data-ajax="false">{l s='Continue shopping' mod='paypal'}</a>
    {else}
        <ul data-role="listview" data-inset="true" id="list_myaccount">
            <li data-theme="a" data-icon="check">
                <a class="underline" href="{$base_uri}mobile" data-ajax="false">{l s='Continue shopping' mod='paypal'}</a>
            </li>
