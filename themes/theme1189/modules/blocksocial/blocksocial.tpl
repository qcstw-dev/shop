...
{if !isset($mobile)}
    <div class="pull-left margin-left-10 margin-top-20" style="width: 27%">
        ...
        <div class="padding-0 thumbnail border-none margin-top-20 margin-bottom-0"><img src="{$base_uri}modules/twocheckout/assets/credit-cards.png" title="Credit card" alt="Credit card" /></div>
    </div>
{/if}