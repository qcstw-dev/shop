...
{if !isset($email_create)}
    <div class="row">
        <div class="col-xs-12 col-sm-{12/$linkWidth}">
            <form action="{$link->getPageLink('custom-shop-authentication', true)|escape:'html':'UTF-8'}" method="post" id="create-account_form" class="box">
        ...
        <div class="col-xs-12 col-sm-{12/$linkWidth}">
            <form action="{$link->getPageLink('custom-shop-authentication', true)|escape:'html':'UTF-8'}" method="post" id="login_form" class="box">
    ...
    {if false && isset($inOrderProcess) && $inOrderProcess && $PS_GUEST_CHECKOUT_ENABLED}
        <form action="{$link->getPageLink('custom-shop-authentication', true, NULL, "back=$back")|escape:'html':'UTF-8'}" method="post" id="new_account_form" class="std clearfix">
            <div class="box">
