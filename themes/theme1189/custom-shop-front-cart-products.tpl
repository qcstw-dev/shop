<div class="cart-content">
    ...
    <a class="btn btn-success checkout-btn col-xs-12" {if !$products}style="display: none"{/if} href="{$base_dir_ssl}shop/{$custom_shop_name}/checkout" title="">{l s='Checkout'} <span class="glyphicon glyphicon-chevron-right"></span></a>
    <div class="clearfix"></div>
</div>
<div class="clearfix"></div>