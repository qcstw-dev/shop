{if isset($products) && $products}
    ...
    {/if}
    <div class="shop" data-side="front_mobile"></div>
            ...
            <div class="col-xs-6 col-md-3 margin-bottom-10 block-product">
                <div class="col-xs-12 border padding-0 shadow">
                    ...
                    <div class="col-xs-12 text-center bold">
                        <div {*href="{$base_uri}mobile-product-page?id_product={$product.id_product}"*} class="quick-view" data-id-product="{$product.id_product}">
                    ...
                    <div class="popup-product-content-{$product.id_product} hidden">
                        <div class="row">
                            <div class="col-xs-12 margin-bottom-10">
                                ...
                                <div {*href="{$base_uri}mobile-product-page?id_product={$product.id_product}"*}  class="btn btn-default pull-right quick-view" data-id-product="{$product.id_product}">
