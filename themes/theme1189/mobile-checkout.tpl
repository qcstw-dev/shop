...
<div id="mobile-checkout">
    <div class="col-xs-12">
        <div class="col-xs-12 title-block" data-block="summary">
            {l s="Summary"} <span class="glyphicon glyphicon-chevron-down pull-right"></span>
        </div>
        <div class="col-xs-12 block-hidden block-summary font-size-13">
            ...
            <div class="col-xs-12 margin-bottom-10 padding-0">
                {if $voucherAllowed}
                    <form action="{$base_uri}checkout" method="post" id="voucher">
                        ...
                        <div class="col-xs-8 padding-0">
                            <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                    <button type="submit" name="submitAddDiscount" class="btn btn-primary">{l s='Ok'}</button>
                                </span>
                            </div>
                        </div>
                    </form>
