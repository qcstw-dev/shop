<div class="block-selection margin-top-10 margin-bottom-10" {if $page_name == 'index' && !$aSelectedProducts && !$aSelectedDesigns}style="display: none"{/if}>
    <div class="col-xs-12 block-selection-top-title padding-0">
        <div class="col-md-9">
            <h4 class="title-block-selection margin-top-10 uppercase">{l s='Your selection'}</h4>
        </div>
        <div class="col-md-3 margin-top-5 margin-bottom-5 clearfix">
            <a class="btn btn-default btn-block-selection pull-right" href="{$base_dir}layout-maker"><span class="glyphicon glyphicon-wrench"></span> Place designs on products</a>
        </div>
    </div>
