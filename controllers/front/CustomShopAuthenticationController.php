...
class CustomShopAuthenticationControllerCore extends CustomShopControllerCore {
    ...
    public function initContent() {
        ...
        $this->setTemplate(_PS_THEME_DIR_ . 'custom-shop-authentication.tpl');
    ...
    protected function sendConfirmationMail(Customer $customer) {
        ...
        return Mail::Send(
                    ...
                    '{custom_shop_logo}' => ($aCustomShop['logo'] ? _PS_BASE_URL_.__PS_BASE_URI__.'img/custom_shop/logo/'.$aCustomShop['logo'] : _PS_BASE_URL_ . __PS_BASE_URI__ . 'img/custom_shop_default_logo.jpg')),
                    $customer->email, 
