...
class CustomShopAddressControllerCore extends CustomShopFrontController {
    ...
    public function initContent() {
        ...
        $this->setTemplate(_PS_THEME_DIR_ . 'custom-shop-address.tpl');
    }
