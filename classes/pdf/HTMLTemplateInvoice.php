...
class HTMLTemplateInvoiceCore extends HTMLTemplate
{
    ...
    public function getContent()
    {
        ...
        $formatted_invoice_address .= '<br />'.$invoice_address->phone.'<br />';
        $formatted_invoice_address .= $invoice_address->phone_mobile.'<br />';
        ...
        if (isset($this->order->id_address_delivery) && $this->order->id_address_delivery) {
            ...
            $formatted_delivery_address .= '<br />'.$delivery_address->phone.'<br />';
            $formatted_delivery_address .= $delivery_address->phone_mobile.'<br />';
        }
