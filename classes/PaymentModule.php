                ...
                if (!$order_creation_failed && isset($order->id)) {
                    ...
                    foreach ($order->product_list as $product) {
                        ...
                        $product_var_tpl = array(
                            ...
                            'thumbnail_custom_picture' => 
                            $product['custom_picture'] ? '<img src="'._PS_BASE_URL_.__PS_BASE_URI__.'img/layout_maker/custom_pictures/'.$product['custom_picture'].'.png" style="width: 100px" />' :
                            '<img src="'._PS_BASE_URL_.__PS_BASE_URI__.'img/custom_shop/creation/'.$product['customized_prod']['custom_img'].'" style="width: 100px" />',
                        );
