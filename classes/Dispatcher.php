...
class DispatcherCore
{
    ...
    public $default_routes = array(
        ...
        'custom_shop_admin_creation' => array(
            'controller' =>    'customshopadmincreation',
            'rule' =>        '{shop_name}/admin/creation',
            'keywords' => array(
                'shop_name' => array('regexp' => '[_a-zA-Z0-9_-]+', 'param' => 'shop_name')
            ),
        ),
        'custom_shop_admin_creation_picture' => array(
            'controller' =>    'customshopadmincreationpicture',
            'rule' =>        '{shop_name}/admin/creation/picture',
            'keywords' => array(
                'shop_name' => array('regexp' => '[_a-zA-Z0-9_-]+', 'param' => 'shop_name'),
            ),
        ),
        'custom_shop_admin_creation_layout_maker' => array(
            'controller' =>    'customshopadmincreationlayoutmaker',
            'rule' =>        '{shop_name}/admin/creation/layout-maker',
            'keywords' => array(
                'shop_name' => array('regexp' => '[_a-zA-Z0-9_-]+', 'param' => 'shop_name'),
            ),
        ),
        ...
        'custom_shop_admin_contact' => array(
            'controller' =>    'customshopadmincontact',
            'rule' =>        '{shop_name}/admin/contact',
            'keywords' => array(
                'shop_name' => array('regexp' => '[_a-zA-Z0-9_-]+', 'param' => 'shop_name')
            ),
        ),
        'custom_shop_admin_questions_and_answers' => array(
            'controller' =>    'customshopadminquestionsandanswers',
            'rule' =>        '{shop_name}/admin/questions-and-answers',
            'keywords' => array(
                'shop_name' => array('regexp' => '[_a-zA-Z0-9_-]+', 'param' => 'shop_name')
            ),
        ),
