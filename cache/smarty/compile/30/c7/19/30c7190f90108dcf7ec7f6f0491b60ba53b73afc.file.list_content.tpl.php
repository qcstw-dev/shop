<?php /* Smarty version Smarty-3.1.19, created on 2016-08-04 01:51:17
         compiled from "C:\wamp64\www\shop\admin4475uqijs\themes\default\template\helpers\list\list_content.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2790857a2d7d5091895-59465870%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '30c7190f90108dcf7ec7f6f0491b60ba53b73afc' => 
    array (
      0 => 'C:\\wamp64\\www\\shop\\admin4475uqijs\\themes\\default\\template\\helpers\\list\\list_content.tpl',
      1 => 1465974074,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2790857a2d7d5091895-59465870',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57a2d7d5bb5623_46745306',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57a2d7d5bb5623_46745306')) {function content_57a2d7d5bb5623_46745306($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include 'C:\\wamp64\\www\\shop\\tools\\smarty\\plugins\\function.counter.php';
?>
...
">
	...
	<?php if ($_smarty_tpl->tpl_vars['has_actions']->value) {?>
		<td class="text-right">
			<?php if (isset($_smarty_tpl->tpl_vars['compiled_actions'])) {$_smarty_tpl->tpl_vars['compiled_actions'] = clone $_smarty_tpl->tpl_vars['compiled_actions'];
$_smarty_tpl->tpl_vars['compiled_actions']->value = array(); $_smarty_tpl->tpl_vars['compiled_actions']->nocache = null; $_smarty_tpl->tpl_vars['compiled_actions']->scope = 0;
} else $_smarty_tpl->tpl_vars['compiled_actions'] = new Smarty_variable(array(), null, 0);?>
...
$_smarty_tpl->tpl_vars['action']->value = $_smarty_tpl->tpl_vars['action']->value; $_smarty_tpl->tpl_vars['action']->nocache = null; $_smarty_tpl->tpl_vars['action']->scope = 0;
} else $_smarty_tpl->tpl_vars['action'] = new Smarty_variable($_smarty_tpl->tpl_vars['action']->value, null, 0);?>
					<?php }?>
