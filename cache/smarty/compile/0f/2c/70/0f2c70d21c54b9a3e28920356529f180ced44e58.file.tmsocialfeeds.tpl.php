...
<?php /*%%SmartyHeaderCode:2398657a2d5a3370b67-90973697%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '2398657a2d5a3370b67-90973697',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57a2d5a3875ff5_64640601',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57a2d5a3875ff5_64640601')) {function content_57a2d5a3875ff5_64640601($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\wamp64\\www\\shop\\tools\\smarty\\plugins\\modifier.escape.php';
...
"
                    ...
                    <?php } elseif ($_smarty_tpl->tpl_vars['content']->value['item_type']=='instagram'&&$_smarty_tpl->tpl_vars['global_instagram']->value) {?>
                        <?php if ($_smarty_tpl->tpl_vars['content']->value['item_limit']&&$_smarty_tpl->tpl_vars['content']->value['item_limit']!='') {?><?php if (isset($_smarty_tpl->tpl_vars["limit"])) {$_smarty_tpl->tpl_vars["limit"] = clone $_smarty_tpl->tpl_vars["limit"];
$_smarty_tpl->tpl_vars["limit"]->value = $_smarty_tpl->tpl_vars['content']->value['item_limit']; $_smarty_tpl->tpl_vars["limit"]->nocache = null; $_smarty_tpl->tpl_vars["limit"]->scope = 0;
} else $_smarty_tpl->tpl_vars["limit"] = new Smarty_variable($_smarty_tpl->tpl_vars['content']->value['item_limit'], null, 0);?><?php } else { ?><?php if (isset($_smarty_tpl->tpl_vars["limit"])) {$_smarty_tpl->tpl_vars["limit"] = clone $_smarty_tpl->tpl_vars["limit"];
$_smarty_tpl->tpl_vars["limit"]->value = 20; $_smarty_tpl->tpl_vars["limit"]->nocache = null; $_smarty_tpl->tpl_vars["limit"]->scope = 0;
} else $_smarty_tpl->tpl_vars["limit"] = new Smarty_variable(20, null, 0);?><?php }?>
