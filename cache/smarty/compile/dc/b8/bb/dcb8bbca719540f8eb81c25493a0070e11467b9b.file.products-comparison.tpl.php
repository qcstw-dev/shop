<?php /* Smarty version Smarty-3.1.19, created on 2016-08-04 03:52:46
         compiled from "C:\wamp64\www\shop\themes\theme1189\products-comparison.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1979757a2f44e5e7980-53315619%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dcb8bbca719540f8eb81c25493a0070e11467b9b' => 
    array (
      0 => 'C:\\wamp64\\www\\shop\\themes\\theme1189\\products-comparison.tpl',
      1 => 1469775910,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1979757a2f44e5e7980-53315619',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57a2f44ed179f2_09561030',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57a2f44ed179f2_09561030')) {function content_57a2f44ed179f2_09561030($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include 'C:\\wamp64\\www\\shop\\tools\\smarty\\plugins\\function.math.php';
	...
	<div class="products_block">
		<table id="product_comparison" class="table table-bordered">
			<tr>
				...
				<?php if (isset($_smarty_tpl->tpl_vars['taxes_behavior'])) {$_smarty_tpl->tpl_vars['taxes_behavior'] = clone $_smarty_tpl->tpl_vars['taxes_behavior'];
$_smarty_tpl->tpl_vars['taxes_behavior']->value = false; $_smarty_tpl->tpl_vars['taxes_behavior']->nocache = null; $_smarty_tpl->tpl_vars['taxes_behavior']->scope = 0;
} else $_smarty_tpl->tpl_vars['taxes_behavior'] = new Smarty_variable(false, null, 0);?>
				<?php if ($_smarty_tpl->tpl_vars['use_taxes']->value&&(!$_smarty_tpl->tpl_vars['priceDisplay']->value||$_smarty_tpl->tpl_vars['priceDisplay']->value==2)) {?>
					<?php if (isset($_smarty_tpl->tpl_vars['taxes_behavior'])) {$_smarty_tpl->tpl_vars['taxes_behavior'] = clone $_smarty_tpl->tpl_vars['taxes_behavior'];
$_smarty_tpl->tpl_vars['taxes_behavior']->value = true; $_smarty_tpl->tpl_vars['taxes_behavior']->nocache = null; $_smarty_tpl->tpl_vars['taxes_behavior']->scope = 0;
} else $_smarty_tpl->tpl_vars['taxes_behavior'] = new Smarty_variable(true, null, 0);?>
				<?php }?>
...
?>
					<?php if (isset($_smarty_tpl->tpl_vars['replace_id'])) {$_smarty_tpl->tpl_vars['replace_id'] = clone $_smarty_tpl->tpl_vars['replace_id'];
$_smarty_tpl->tpl_vars['replace_id']->value = ($_smarty_tpl->tpl_vars['product']->value->id).('|'); $_smarty_tpl->tpl_vars['replace_id']->nocache = null; $_smarty_tpl->tpl_vars['replace_id']->scope = 0;
} else $_smarty_tpl->tpl_vars['replace_id'] = new Smarty_variable(($_smarty_tpl->tpl_vars['product']->value->id).('|'), null, 0);?>
								...
								<div class="button-container">
									<?php if ((!$_smarty_tpl->tpl_vars['product']->value->hasAttributes()||(isset($_smarty_tpl->tpl_vars['add_prod_display']->value)&&($_smarty_tpl->tpl_vars['add_prod_display']->value==1)))&&$_smarty_tpl->tpl_vars['product']->value->minimal_quantity==1&&$_smarty_tpl->tpl_vars['product']->value->customizable!=2&&!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?>
										<?php if (($_smarty_tpl->tpl_vars['product']->value->quantity>0||$_smarty_tpl->tpl_vars['product']->value->allow_oosp)) {?>
											<a class="ajax_add_to_cart_button btn btn-default" data-id-product="<?php echo $_smarty_tpl->tpl_vars['product']->value->id;?>
...
">
										...
										<?php }?>
									<?php }?>
									<a class="lnk_view btn btn-default" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->getLink(), ENT_QUOTES, 'UTF-8', true);?>
...
$_smarty_tpl->tpl_vars['product']->_loop = true;
?>
							<?php if (isset($_smarty_tpl->tpl_vars['product_id'])) {$_smarty_tpl->tpl_vars['product_id'] = clone $_smarty_tpl->tpl_vars['product_id'];
$_smarty_tpl->tpl_vars['product_id']->value = $_smarty_tpl->tpl_vars['product']->value->id; $_smarty_tpl->tpl_vars['product_id']->nocache = null; $_smarty_tpl->tpl_vars['product_id']->scope = 0;
} else $_smarty_tpl->tpl_vars['product_id'] = new Smarty_variable($_smarty_tpl->tpl_vars['product']->value->id, null, 0);?>
							<?php if (isset($_smarty_tpl->tpl_vars['feature_id'])) {$_smarty_tpl->tpl_vars['feature_id'] = clone $_smarty_tpl->tpl_vars['feature_id'];
$_smarty_tpl->tpl_vars['feature_id']->value = $_smarty_tpl->tpl_vars['feature']->value['id_feature']; $_smarty_tpl->tpl_vars['feature_id']->nocache = null; $_smarty_tpl->tpl_vars['feature_id']->scope = 0;
} else $_smarty_tpl->tpl_vars['feature_id'] = new Smarty_variable($_smarty_tpl->tpl_vars['feature']->value['id_feature'], null, 0);?>
							<?php if (isset($_smarty_tpl->tpl_vars['product_features']->value[$_smarty_tpl->tpl_vars['product_id']->value])) {?>
								<?php if (isset($_smarty_tpl->tpl_vars['tab'])) {$_smarty_tpl->tpl_vars['tab'] = clone $_smarty_tpl->tpl_vars['tab'];
$_smarty_tpl->tpl_vars['tab']->value = $_smarty_tpl->tpl_vars['product_features']->value[$_smarty_tpl->tpl_vars['product_id']->value]; $_smarty_tpl->tpl_vars['tab']->nocache = null; $_smarty_tpl->tpl_vars['tab']->scope = 0;
} else $_smarty_tpl->tpl_vars['tab'] = new Smarty_variable($_smarty_tpl->tpl_vars['product_features']->value[$_smarty_tpl->tpl_vars['product_id']->value], null, 0);?>
								<td class="<?php echo $_smarty_tpl->tpl_vars['classname']->value;?>
...
<ul class="footer_link">
	<li>
		<a class="btn btn-default icon-left" href="<?php echo $_smarty_tpl->tpl_vars['base_dir']->value;?>
