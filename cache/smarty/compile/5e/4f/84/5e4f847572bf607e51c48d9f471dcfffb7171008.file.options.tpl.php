<?php /* Smarty version Smarty-3.1.19, created on 2016-08-04 01:47:20
         compiled from "C:\wamp64\www\shop\admin4475uqijs\themes\default\template\controllers\themes\helpers\options\options.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1031957a2d6e83bd3b1-67570772%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5e4f847572bf607e51c48d9f471dcfffb7171008' => 
    array (
      0 => 'C:\\wamp64\\www\\shop\\admin4475uqijs\\themes\\default\\template\\controllers\\themes\\helpers\\options\\options.tpl',
      1 => 1465974074,
      2 => 'file',
    ),
    'b2c53fe643cabdaada4091be7960956a739f6a38' => 
    array (
      0 => 'C:\\wamp64\\www\\shop\\admin4475uqijs\\themes\\default\\template\\helpers\\options\\options.tpl',
      1 => 1465974074,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1031957a2d6e83bd3b1-67570772',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57a2d6e99863d4_14861750',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57a2d6e99863d4_14861750')) {function content_57a2d6e99863d4_14861750($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include 'C:\\wamp64\\www\\shop\\tools\\smarty\\plugins\\function.counter.php';
if (!is_callable('smarty_modifier_escape')) include 'C:\\wamp64\\www\\shop\\tools\\smarty\\plugins\\modifier.escape.php';
if (!is_callable('smarty_modifier_replace')) include 'C:\\wamp64\\www\\shop\\tools\\smarty\\plugins\\modifier.replace.php';
?>
...
<?php }?>
	...
	<?php if (isset($_smarty_tpl->tpl_vars['categoryData']->value['after_tabs'])) {?>
		<?php if (isset($_smarty_tpl->tpl_vars['cur_theme'])) {$_smarty_tpl->tpl_vars['cur_theme'] = clone $_smarty_tpl->tpl_vars['cur_theme'];
$_smarty_tpl->tpl_vars['cur_theme']->value = $_smarty_tpl->tpl_vars['categoryData']->value['after_tabs']['cur_theme']; $_smarty_tpl->tpl_vars['cur_theme']->nocache = null; $_smarty_tpl->tpl_vars['cur_theme']->scope = 0;
} else $_smarty_tpl->tpl_vars['cur_theme'] = new Smarty_variable($_smarty_tpl->tpl_vars['categoryData']->value['after_tabs']['cur_theme'], null, 0);?>
