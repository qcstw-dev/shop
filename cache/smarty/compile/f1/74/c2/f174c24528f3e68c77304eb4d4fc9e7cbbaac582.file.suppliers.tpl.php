<?php /* Smarty version Smarty-3.1.19, created on 2016-08-03 05:18:30
         compiled from "C:\wamp64\www\shop\admin4475uqijs\themes\default\template\controllers\products\suppliers.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2797657a1b6e6bbd0c2-59138954%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f174c24528f3e68c77304eb4d4fc9e7cbbaac582' => 
    array (
      0 => 'C:\\wamp64\\www\\shop\\admin4475uqijs\\themes\\default\\template\\controllers\\products\\suppliers.tpl',
      1 => 1465974074,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2797657a1b6e6bbd0c2-59138954',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57a1b6e7cf9e05_65561059',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57a1b6e7cf9e05_65561059')) {function content_57a1b6e7cf9e05_65561059($_smarty_tpl) {?>
...
?>
							<?php if (isset($_smarty_tpl->tpl_vars['reference'])) {$_smarty_tpl->tpl_vars['reference'] = clone $_smarty_tpl->tpl_vars['reference'];
$_smarty_tpl->tpl_vars['reference']->value = ''; $_smarty_tpl->tpl_vars['reference']->nocache = null; $_smarty_tpl->tpl_vars['reference']->scope = 0;
} else $_smarty_tpl->tpl_vars['reference'] = new Smarty_variable('', null, 0);?>
							<?php if (isset($_smarty_tpl->tpl_vars['price_te'])) {$_smarty_tpl->tpl_vars['price_te'] = clone $_smarty_tpl->tpl_vars['price_te'];
$_smarty_tpl->tpl_vars['price_te']->value = ''; $_smarty_tpl->tpl_vars['price_te']->nocache = null; $_smarty_tpl->tpl_vars['price_te']->scope = 0;
} else $_smarty_tpl->tpl_vars['price_te'] = new Smarty_variable('', null, 0);?>
							<?php if (isset($_smarty_tpl->tpl_vars['id_currency'])) {$_smarty_tpl->tpl_vars['id_currency'] = clone $_smarty_tpl->tpl_vars['id_currency'];
$_smarty_tpl->tpl_vars['id_currency']->value = $_smarty_tpl->tpl_vars['id_default_currency']->value; $_smarty_tpl->tpl_vars['id_currency']->nocache = null; $_smarty_tpl->tpl_vars['id_currency']->scope = 0;
} else $_smarty_tpl->tpl_vars['id_currency'] = new Smarty_variable($_smarty_tpl->tpl_vars['id_default_currency']->value, null, 0);?>
...
?>
								<?php if ($_smarty_tpl->tpl_vars['asc']->value->id_product==$_smarty_tpl->tpl_vars['attribute']->value['id_product']&&$_smarty_tpl->tpl_vars['asc']->value->id_product_attribute==$_smarty_tpl->tpl_vars['attribute']->value['id_product_attribute']&&$_smarty_tpl->tpl_vars['asc']->value->id_supplier==$_smarty_tpl->tpl_vars['supplier']->value->id_supplier) {?>
									<?php if (isset($_smarty_tpl->tpl_vars['reference'])) {$_smarty_tpl->tpl_vars['reference'] = clone $_smarty_tpl->tpl_vars['reference'];
$_smarty_tpl->tpl_vars['reference']->value = $_smarty_tpl->tpl_vars['asc']->value->product_supplier_reference; $_smarty_tpl->tpl_vars['reference']->nocache = null; $_smarty_tpl->tpl_vars['reference']->scope = 0;
} else $_smarty_tpl->tpl_vars['reference'] = new Smarty_variable($_smarty_tpl->tpl_vars['asc']->value->product_supplier_reference, null, 0);?>
									<?php if (isset($_smarty_tpl->tpl_vars['price_te'])) {$_smarty_tpl->tpl_vars['price_te'] = clone $_smarty_tpl->tpl_vars['price_te'];
$_smarty_tpl->tpl_vars['price_te']->value = Tools::ps_round($_smarty_tpl->tpl_vars['asc']->value->product_supplier_price_te,2); $_smarty_tpl->tpl_vars['price_te']->nocache = null; $_smarty_tpl->tpl_vars['price_te']->scope = 0;
} else $_smarty_tpl->tpl_vars['price_te'] = new Smarty_variable(Tools::ps_round($_smarty_tpl->tpl_vars['asc']->value->product_supplier_price_te,2), null, 0);?>
									<?php if ($_smarty_tpl->tpl_vars['asc']->value->id_currency) {?>
										<?php if (isset($_smarty_tpl->tpl_vars['id_currency'])) {$_smarty_tpl->tpl_vars['id_currency'] = clone $_smarty_tpl->tpl_vars['id_currency'];
$_smarty_tpl->tpl_vars['id_currency']->value = $_smarty_tpl->tpl_vars['asc']->value->id_currency; $_smarty_tpl->tpl_vars['id_currency']->nocache = null; $_smarty_tpl->tpl_vars['id_currency']->scope = 0;
} else $_smarty_tpl->tpl_vars['id_currency'] = new Smarty_variable($_smarty_tpl->tpl_vars['asc']->value->id_currency, null, 0);?>
									<?php }?>
								<?php }?>
							<?php } ?>
