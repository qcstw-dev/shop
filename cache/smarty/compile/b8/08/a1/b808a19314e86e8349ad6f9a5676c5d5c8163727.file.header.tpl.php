<?php /* Smarty version Smarty-3.1.19, created on 2016-08-05 03:04:24
         compiled from "C:\wamp64\www\shop\admin4475uqijs\themes\default\template\header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2908857a43a78f349d7-47770585%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b808a19314e86e8349ad6f9a5676c5d5c8163727' => 
    array (
      0 => 'C:\\wamp64\\www\\shop\\admin4475uqijs\\themes\\default\\template\\header.tpl',
      1 => 1465974074,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2908857a43a78f349d7-47770585',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57a43a798f2214_66699882',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57a43a798f2214_66699882')) {function content_57a43a798f2214_66699882($_smarty_tpl) {?>
<!DOCTYPE html>
...
<?php $_tmp4=ob_get_clean();?><?php if ($_smarty_tpl->tpl_vars['link']->value->matchQuickLink($_tmp4)) {?><?php if (isset($_smarty_tpl->tpl_vars["matchQuickLink"])) {$_smarty_tpl->tpl_vars["matchQuickLink"] = clone $_smarty_tpl->tpl_vars["matchQuickLink"];
$_smarty_tpl->tpl_vars["matchQuickLink"]->value = $_smarty_tpl->tpl_vars['quick']->value['id_quick_access']; $_smarty_tpl->tpl_vars["matchQuickLink"]->nocache = null; $_smarty_tpl->tpl_vars["matchQuickLink"]->scope = 0;
} else $_smarty_tpl->tpl_vars["matchQuickLink"] = new Smarty_variable($_smarty_tpl->tpl_vars['quick']->value['id_quick_access'], null, 0);?>class="active"<?php }?>>
...
">
				...
				<?php if (isset($_smarty_tpl->tpl_vars['quick_access_current_link_name'])) {$_smarty_tpl->tpl_vars['quick_access_current_link_name'] = clone $_smarty_tpl->tpl_vars['quick_access_current_link_name'];
$_smarty_tpl->tpl_vars['quick_access_current_link_name']->value = explode(" - ",$_smarty_tpl->tpl_vars['quick_access_current_link_name']->value); $_smarty_tpl->tpl_vars['quick_access_current_link_name']->nocache = null; $_smarty_tpl->tpl_vars['quick_access_current_link_name']->scope = 0;
} else $_smarty_tpl->tpl_vars['quick_access_current_link_name'] = new Smarty_variable(explode(" - ",$_smarty_tpl->tpl_vars['quick_access_current_link_name']->value), null, 0);?>
				<script>
					$(function() {
