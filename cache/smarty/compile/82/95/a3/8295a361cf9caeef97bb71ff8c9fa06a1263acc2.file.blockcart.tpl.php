<?php /* Smarty version Smarty-3.1.19, created on 2016-08-04 01:41:50
         compiled from "C:\wamp64\www\shop\themes\theme1189\modules\blockcart\blockcart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2080957a2d59e120db0-90322449%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8295a361cf9caeef97bb71ff8c9fa06a1263acc2' => 
    array (
      0 => 'C:\\wamp64\\www\\shop\\themes\\theme1189\\modules\\blockcart\\blockcart.tpl',
      1 => 1469775909,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2080957a2d59e120db0-90322449',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57a2d59f0ea8e8_11348233',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57a2d59f0ea8e8_11348233')) {function content_57a2d59f0ea8e8_11348233($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'C:\\wamp64\\www\\shop\\tools\\smarty\\plugins\\modifier.replace.php';
...
<div class="basket clearfix<?php if ($_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?> header_user_catalog<?php }?>">
<?php }?>
			...
			<span class="ajax_cart_total<?php if ($_smarty_tpl->tpl_vars['cart_qties']->value==0) {?> unvisible<?php }?>">
				<?php if ($_smarty_tpl->tpl_vars['cart_qties']->value>0) {?>
					<?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value==1) {?>
						<?php if (isset($_smarty_tpl->tpl_vars['blockcart_cart_flag'])) {$_smarty_tpl->tpl_vars['blockcart_cart_flag'] = clone $_smarty_tpl->tpl_vars['blockcart_cart_flag'];
$_smarty_tpl->tpl_vars['blockcart_cart_flag']->value = constant('Cart::BOTH_WITHOUT_SHIPPING'); $_smarty_tpl->tpl_vars['blockcart_cart_flag']->nocache = null; $_smarty_tpl->tpl_vars['blockcart_cart_flag']->scope = 0;
} else $_smarty_tpl->tpl_vars['blockcart_cart_flag'] = new Smarty_variable(constant('Cart::BOTH_WITHOUT_SHIPPING'), null, 0);?>
...
" rel="nofollow">
						...
						<div class="cart-prices">
							<div class="cart-prices-line first-line <?php if (!($_smarty_tpl->tpl_vars['page_name']->value=='order-opc')&&$_smarty_tpl->tpl_vars['shipping_cost_float']->value==0&&(!isset($_smarty_tpl->tpl_vars['cart']->value->id_address_delivery)||!$_smarty_tpl->tpl_vars['cart']->value->id_address_delivery)) {?> unvisible<?php }?>">
