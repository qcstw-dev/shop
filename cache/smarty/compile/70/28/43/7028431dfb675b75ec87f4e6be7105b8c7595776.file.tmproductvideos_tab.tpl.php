<?php /* Smarty version Smarty-3.1.19, created on 2016-08-03 05:18:30
         compiled from "C:\wamp64\www\shop\modules\tmproductvideos\views\templates\admin\tmproductvideos_tab.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1367157a1b6e60d7b41-48078563%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7028431dfb675b75ec87f4e6be7105b8c7595776' => 
    array (
      0 => 'C:\\wamp64\\www\\shop\\modules\\tmproductvideos\\views\\templates\\admin\\tmproductvideos_tab.tpl',
      1 => 1469775911,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1367157a1b6e60d7b41-48078563',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57a1b6e6e49744_91433113',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57a1b6e6e49744_91433113')) {function content_57a1b6e6e49744_91433113($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\wamp64\\www\\shop\\tools\\smarty\\plugins\\modifier.escape.php';
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <?php if ($_smarty_tpl->tpl_vars['v']->value['video_type']=='youtube') {?>
                                            	<div class="video-preview">
                                                 	<iframe type="text/html" width="250" height="200" frameborder="0" src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['v']->value['video_link'], ENT_QUOTES, 'UTF-8', true);?>
?enablejsapi=1&version=3&html5=1&showinfo=0&autoplay=0&controls=0"></iframe>
...
" class="btn btn-default"><i class="process-icon-cancel"></i> <?php echo smartyTranslate(array('s'=>'Cancel','mod'=>'tmproductvideos'),$_smarty_tpl);?>
            ...
            <button type="submit" name="submitAddproduct" class="btn btn-default pull-right" disabled="disabled"><i class="process-icon-loading"></i> <?php echo smartyTranslate(array('s'=>'Save','mod'=>'tmproductvideos'),$_smarty_tpl);?>
</button>
            <button type="submit" name="submitAddproductAndStay" class="btn btn-default pull-right" disabled="disabled"><i class="process-icon-loading"></i> <?php echo smartyTranslate(array('s'=>'Save and stay','mod'=>'tmproductvideos'),$_smarty_tpl);?>
</button>
        </div>
    <?php }?>
</div>
