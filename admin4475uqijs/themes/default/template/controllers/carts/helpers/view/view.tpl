                            ...
                            <tr>
                                <td class="text-center">
                                    {if $product.id_customized_prod}
                                        <a href="{$base_url}img/custom_shop/creation/{$product.customized_prod.custom_img}" target="_blank">
                                            <img width="200" src="{$base_url}img/custom_shop/creation/{$product.customized_prod.custom_img}" alt="{$product.name}" title="{$product.name}" />
                                        </a>
